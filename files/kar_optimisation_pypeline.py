...
Пайплайн оптимизации выполняется в несколько этапов:
  ...
  2. calc_first_stage + first_stage_update  — расчёт и корректировка 1 ступени [необходимо добавть возможность добавлять переходное сопротивление]
  3. calc_second_stage + second_stage_update — расчёт и корректировка 2 ступени [необходимо добавть возможность добавлять переходное сопротивление]

    ...
    def build(self):
        ...
        if not self.builded:
            ...
            for kq in self.qlist:
                res.append("\n")
                res.append("{} = mrtkz.Q(mdl, '{}', desc='{}')\n".format(kq.tlname, kq.desc, kq.name))
            res.append("\n")
            res.append("\n")
            res.append("#ВЕТВИ\n")
...
class ImpModel:
    ...
    def ImpFromXLS(self, filename):
        ...
        print("Имена листов в рабочей книге:")
